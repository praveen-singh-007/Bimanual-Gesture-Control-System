...
class HandTracking():
    ...
    def __init__(self, min_track_conf=0.5, min_detect_conf = 0.5, num_hands = 2, model_complex=0, mode=False):
        ...
        # self.hand_detection = True

    def find_hands(self, frame, hand_detection =  True, draw = True):
    ...
    def findPosition(self, frame, handNo, draw=True):
        ...
        return self.lmList, hand_type
    
    def finger_up(self, hand_type):
        fingers = []
